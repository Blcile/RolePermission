...
//    [MyAuthorize]
    ...
    {
        private readonly SMFIELDService SMFIELDService;
        ...
        public ActionResult Create(SMFIELD entity)
        {
            if (entity != null && ModelState.IsValid)
            {
                ...
                SMLOG _SMLOG = new SMLOG { OPERATION_TYPE = "N",FUNC_CODE = "010021",USER_ID = GetCurrentAccount().USER_ID,CLASSNAME = this.GetType().ToString() + ": Create"};
        ...
        public ActionResult Edit(SMFIELD entity)
        {
            ...
            {   //数据校验
                ...
                string returnValue = string.Empty;
                SMLOG _SMLOG = new SMLOG { OPERATION_TYPE = "U", FUNC_CODE = "010022", USER_ID = GetCurrentAccount().USER_ID, CLASSNAME = this.GetType().ToString() + ": Edit" };
        ...
        public ActionResult Delete(IFormCollection collection)
        {
            ...
            {
                SMLOG _SMLOG = new SMLOG { OPERATION_TYPE = "D", FUNC_CODE = "010023", USER_ID = GetCurrentAccount().USER_ID, CLASSNAME = this.GetType().ToString() + ": Delete" };
