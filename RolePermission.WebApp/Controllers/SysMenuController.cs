...
namespace RolePermission.WebApp.Controllers
{
    ...
    public class SysMenuController : BaseController
    {
        ...
        private readonly SMMENUROLEFUNCTBService SMMENUROLEFUNCTBService;
        ...
        public ActionResult Create(SMMENUTB entity)
        {
            if (entity != null && ModelState.IsValid)
            {
                ...
                SMLOG OperLog = new SMLOG { OPERATION_TYPE = "N", FUNC_CODE = "900001", USER_ID = Convert.ToInt32(GetCurrentAccount().USER_ID), CLASSNAME = ClassName + ": Create" };
        ...
        public ActionResult Edit(string id, SMMENUTB entity)
        {
            ...
            {   //数据校验
                ...
                SMLOG OperLog = new SMLOG { OPERATION_TYPE = "U", FUNC_CODE = "900002", USER_ID = Convert.ToInt32(GetCurrentAccount().USER_ID), CLASSNAME = ClassName + ": Edit" };
        ...
        public ActionResult Delete(IFormCollection collection)
        {
            ...
            {
                SMLOG OperLog = new SMLOG { OPERATION_TYPE = "D", FUNC_CODE = "900003", USER_ID = Convert.ToInt32(GetCurrentAccount().USER_ID), CLASSNAME = ClassName + ": Delete" };
        ...
        public ActionResult GetAllMetadata2(string id)
        {
            var rows = SMMENUTBService.GetAllMetadata().ToList().Select(s =>
                    ...
                    ,
                            _parentId = s.PARENTID
                    ,
                            isCheck = string.Join(",", s.SMFUNCTB.Select(t => t.Func.FUNC_ID + "^" + t.Func.FUNC_NAME))
                    ,
                            iconCls = s.ICONIC
