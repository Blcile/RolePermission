...
namespace RolePermission.WebApp.Controllers
{
    ...
    public class SysOperationController : BaseController
    {
        ...
        private readonly SMMENUTBService SMMENUTBService;
        private readonly SMFUNCTBService SMFUNCTBService;
        ...
        public ActionResult Create(SMFUNCTB entity)
        {
            if (entity != null && ModelState.IsValid)
            {
                ...
                SMLOG OperLog = new SMLOG { OPERATION_TYPE = "N", FUNC_CODE = "900011", USER_ID = Convert.ToInt32(GetCurrentAccount().USER_ID), CLASSNAME = ClassName + ": Create" };
        ...
        public ActionResult Edit(string id, SMFUNCTB entity)
        {
            ...
            {
                string returnValue = string.Empty;
                SMLOG OperLog = new SMLOG { OPERATION_TYPE = "U", FUNC_CODE = "900012", USER_ID = Convert.ToInt32(GetCurrentAccount().USER_ID), CLASSNAME = ClassName + ": Edit" };
        ...
        public ActionResult Delete(IFormCollection collection)
        {
            ...
            {
                SMLOG OperLog = new SMLOG { OPERATION_TYPE = "D", FUNC_CODE = "900013", USER_ID = Convert.ToInt32(GetCurrentAccount().USER_ID), CLASSNAME = ClassName + ": Delete" };
        ...
        //    {
        //        string returnValue = string.Empty;
        //        SMLOG OperLog = new SMLOG { OPERATION_TYPE = "U", FUNC_CODE = "900010", USER_ID = Convert.ToInt32(GetCurrentAccount().USER_ID), CLASSNAME = ClassName + ": SetSysMenu" };
