    ...
    public class SysUserController : BaseController
    {
        ...
        public ActionResult Create(SMUSERTB entity)
        {
            if (entity != null && ModelState.IsValid)
            {
                ...
                SMLOG _SMLOG = new SMLOG { OPERATION_TYPE = "N", FUNC_CODE = "010702", USER_ID = GetCurrentAccount().USER_ID, CLASSNAME = this.GetType().ToString() + ": Create" };
        ...
        public ActionResult Edit(int id, SMUSERTB entity)
        {
            if (entity != null && ModelState.IsValid)
            {
                ...
                string returnValue = string.Empty;
                SMLOG _SMLOG = new SMLOG { OPERATION_TYPE = "U", FUNC_CODE = "010702", USER_ID = Convert.ToInt32(GetCurrentAccount().USER_ID), CLASSNAME = this.GetType().ToString() + ": Edit" };
        ...
        public ActionResult Delete(IFormCollection collection)
        {
            ...
            {
                SMLOG _SMLOG = new SMLOG { OPERATION_TYPE = "D", FUNC_CODE = "010000", USER_ID = Convert.ToInt32(GetCurrentAccount().USER_ID), CLASSNAME = this.GetType().ToString() + ": Delete" };
